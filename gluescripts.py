...
def MyTransform(glueContext, dfc) -> DynamicFrameCollection:
    ...
    prd_df2 = prd_dfs.select("_sdc_batched_at","_sdc_table_version","_sdc_received_at","_sdc_sequence","order_id","product_id","sku","prd_struct.*")
...
## @type: CustomCode
## @args: [dynamicFrameConstruction = DynamicFrameCollection({"DataSource0": DataSource0}, glueContext), className = MyTransform, transformation_ctx = "Transform7"]
## @return: Transform7
## @inputs: [dfc = DataSource0]
Transform7 = MyTransform(glueContext, DynamicFrameCollection({"DataSource0": DataSource0}, glueContext))
## @type: SelectFromCollection
## @args: [key = list(Transform7.keys())[0], transformation_ctx = "Transform8"]
## @return: Transform8
...
## @type: DataSink
## @args: [connection_type = "s3", format = "json", connection_options = {"path": "s3://trx-data-lake-processed/USbigCommerce/testoutput/OrderShippingAddresses/", "partitionKeys": []}, transformation_ctx = "DataSink3"]
## @return: DataSink3
## @inputs: [frame = Transform8]
DataSink3 = glueContext.write_dynamic_frame.from_options(frame = Transform8, connection_type = "s3", format = "json", connection_options = {"path": "s3://trx-data-lake-processed/USbigCommerce/testoutput/OrderShippingAddresses/", "partitionKeys": []}, transformation_ctx = "DataSink3")
## @type: CustomCode
## @args: [dynamicFrameConstruction = DynamicFrameCollection({"DataSource0": DataSource0}, glueContext), className = MyTransform, transformation_ctx = "Transform6"]
## @return: Transform6
## @inputs: [dfc = DataSource0]
Transform6 = MyTransform(glueContext, DynamicFrameCollection({"DataSource0": DataSource0}, glueContext))
## @type: SelectFromCollection
...
## @type: SelectFields
## @args: [paths = ["_sdc_batched_at", "_sdc_table_version", "_sdc_received_at", "_sdc_sequence", "external_merchant_id", "geoip_country", "date_shipped", "base_wrapping_cost", "shipping_cost_ex_tax", "total_inc_tax", "wrapping_cost_ex_tax", "currency_id", "items_total", "channel_id", "ebay_order_id", "shipping_cost_tax", "currency_code", "is_email_opt_in", "handling_cost_tax", "shipping_cost_inc_tax", "gift_certificate_amount", "payment_provider_id", "payment_method", "wrapping_cost_tax_class_id", "handling_cost_tax_class_id", "base_shipping_cost", "external_id", "wrapping_cost_inc_tax", "tax_provider_id", "id", "date_modified", "discount_amount", "coupon_discount", "refunded_amount", "total_ex_tax", "subtotal_inc_tax", "staff_notes", "status", "cart_id", "wrapping_cost_tax", "shipping_cost_tax_class_id", "status_id", "default_currency_id", "geoip_country_iso2", "customer_id", "base_handling_cost", "handling_cost_inc_tax", "store_credit_amount", "custom_status", "customer_message", "handling_cost_ex_tax", "currency_exchange_rate", "is_deleted", "order_is_digital", "ip_address", "default_currency_code", "shipping_address_count", "subtotal_tax", "payment_status", "items_shipped", "external_source", "date_created", "total_tax", "order_source", "subtotal_ex_tax", "street_1", "country", "country_iso2", "city", "company", "email", "last_name", "street_2", "first_name", "phone", "state", "form_fields", "zip"], transformation_ctx = "Transform9"]
## @return: Transform9
## @inputs: [frame = Transform5]
Transform9 = SelectFields.apply(frame = Transform5, paths = ["_sdc_batched_at", "_sdc_table_version", "_sdc_received_at", "_sdc_sequence", "external_merchant_id", "geoip_country", "date_shipped", "base_wrapping_cost", "shipping_cost_ex_tax", "total_inc_tax", "wrapping_cost_ex_tax", "currency_id", "items_total", "channel_id", "ebay_order_id", "shipping_cost_tax", "currency_code", "is_email_opt_in", "handling_cost_tax", "shipping_cost_inc_tax", "gift_certificate_amount", "payment_provider_id", "payment_method", "wrapping_cost_tax_class_id", "handling_cost_tax_class_id", "base_shipping_cost", "external_id", "wrapping_cost_inc_tax", "tax_provider_id", "id", "date_modified", "discount_amount", "coupon_discount", "refunded_amount", "total_ex_tax", "subtotal_inc_tax", "staff_notes", "status", "cart_id", "wrapping_cost_tax", "shipping_cost_tax_class_id", "status_id", "default_currency_id", "geoip_country_iso2", "customer_id", "base_handling_cost", "handling_cost_inc_tax", "store_credit_amount", "custom_status", "customer_message", "handling_cost_ex_tax", "currency_exchange_rate", "is_deleted", "order_is_digital", "ip_address", "default_currency_code", "shipping_address_count", "subtotal_tax", "payment_status", "items_shipped", "external_source", "date_created", "total_tax", "order_source", "subtotal_ex_tax", "street_1", "country", "country_iso2", "city", "company", "email", "last_name", "street_2", "first_name", "phone", "state", "form_fields", "zip"], transformation_ctx = "Transform9")
## @type: DataSink
...
DataSink4 = glueContext.write_dynamic_frame.from_options(frame = Transform9, connection_type = "s3", format = "json", connection_options = {"path": "s3://trx-data-lake-processed/USbigCommerce/testoutput/OrderHeader /", "partitionKeys": []}, transformation_ctx = "DataSink4")
## @type: CustomCode
## @args: [dynamicFrameConstruction = DynamicFrameCollection({"DataSource0": DataSource0}, glueContext), className = MyTransform, transformation_ctx = "Transform4"]
## @return: Transform4
## @inputs: [dfc = DataSource0]
Transform4 = MyTransform(glueContext, DynamicFrameCollection({"DataSource0": DataSource0}, glueContext))
## @type: SelectFromCollection
## @args: [key = list(Transform4.keys())[0], transformation_ctx = "Transform11"]
## @return: Transform11
## @inputs: [dfc = Transform4]
Transform11 = SelectFromCollection.apply(dfc = Transform4, key = list(Transform4.keys())[0], transformation_ctx = "Transform11")
## @type: DataSink
## @args: [connection_type = "s3", format = "json", connection_options = {"path": "s3://trx-data-lake-processed/USbigCommerce/testoutput/OrderProductDiscounts/", "partitionKeys": []}, transformation_ctx = "DataSink1"]
## @return: DataSink1
## @inputs: [frame = Transform11]
DataSink1 = glueContext.write_dynamic_frame.from_options(frame = Transform11, connection_type = "s3", format = "json", connection_options = {"path": "s3://trx-data-lake-processed/USbigCommerce/testoutput/OrderProductDiscounts/", "partitionKeys": []}, transformation_ctx = "DataSink1")
## @type: CustomCode
## @args: [dynamicFrameConstruction = DynamicFrameCollection({"DataSource0": DataSource0}, glueContext), className = MyTransform, transformation_ctx = "Transform3"]
## @return: Transform3
## @inputs: [dfc = DataSource0]
Transform3 = MyTransform(glueContext, DynamicFrameCollection({"DataSource0": DataSource0}, glueContext))
## @type: SelectFromCollection
...
## @type: DataSink
## @args: [connection_type = "s3", format = "json", connection_options = {"path": "s3://trx-data-lake-processed/USbigCommerce/testoutput/OrderDiscounts/", "partitionKeys": []}, transformation_ctx = "DataSink0"]
## @return: DataSink0
## @inputs: [frame = Transform1]
DataSink0 = glueContext.write_dynamic_frame.from_options(frame = Transform1, connection_type = "s3", format = "json", connection_options = {"path": "s3://trx-data-lake-processed/USbigCommerce/testoutput/OrderDiscounts/", "partitionKeys": []}, transformation_ctx = "DataSink0")
## @type: CustomCode
...
## @type: SelectFields
## @args: [paths = ["_sdc_batched_at", "_sdc_table_version", "_sdc_received_at", "_sdc_sequence", "product_id", "cost_price_inc_tax", "base_wrapping_cost", "total_inc_tax", "wrapping_cost_ex_tax", "width", "sku", "quantity_shipped", "event_date", "return_id", "base_total", "price_ex_tax", "height", "option_set_id", "is_bundled_product", "external_id", "wrapping_cost_inc_tax", "price_inc_tax", "cost_price_tax", "id", "refund_amount", "wrapping_name", "total_ex_tax", "bin_picking_number", "wrapping_message", "name", "quantity", "cost_price_ex_tax", "ebay_transaction_id", "order_id", "applied_discounts.amount", "applied_discounts.code", "applied_discounts.name", "applied_discounts.id", "wrapping_cost_tax", "is_refunded", "fixed_shipping_cost", "order_address_id", "type", "parent_order_product_id", "depth", "quantity_refunded", "ebay_item_id", "base_price", "event_name", "base_cost_price", "product_options.display_style", "product_options.display_value", "product_options.option_id", "product_options.id", "product_options.name", "product_options.value", "product_options.product_option_id", "product_options.display_name", "product_options.order_product_id", "product_options.type", "weight", "price_tax", "total_tax"], transformation_ctx = "Transform10"]
## @return: Transform10
## @inputs: [frame = Transform2]
Transform10 = SelectFields.apply(frame = Transform2, paths = ["_sdc_batched_at", "_sdc_table_version", "_sdc_received_at", "_sdc_sequence", "product_id", "cost_price_inc_tax", "base_wrapping_cost", "total_inc_tax", "wrapping_cost_ex_tax", "width", "sku", "quantity_shipped", "event_date", "return_id", "base_total", "price_ex_tax", "height", "option_set_id", "is_bundled_product", "external_id", "wrapping_cost_inc_tax", "price_inc_tax", "cost_price_tax", "id", "refund_amount", "wrapping_name", "total_ex_tax", "bin_picking_number", "wrapping_message", "name", "quantity", "cost_price_ex_tax", "ebay_transaction_id", "order_id", "applied_discounts.amount", "applied_discounts.code", "applied_discounts.name", "applied_discounts.id", "wrapping_cost_tax", "is_refunded", "fixed_shipping_cost", "order_address_id", "type", "parent_order_product_id", "depth", "quantity_refunded", "ebay_item_id", "base_price", "event_name", "base_cost_price", "product_options.display_style", "product_options.display_value", "product_options.option_id", "product_options.id", "product_options.name", "product_options.value", "product_options.product_option_id", "product_options.display_name", "product_options.order_product_id", "product_options.type", "weight", "price_tax", "total_tax"], transformation_ctx = "Transform10")
## @type: DataSink
...
DataSink2 = glueContext.write_dynamic_frame.from_options(frame = Transform10, connection_type = "s3", format = "json", connection_options = {"path": "s3://trx-data-lake-processed/USbigCommerce/testoutput/OrderDetails/", "partitionKeys": []}, transformation_ctx = "DataSink2")
job.commit()